...
const translations = {
    es: {
        ...
        aeonbook_d:"The Aeon Book fue un proyecto universitario, el cual es un pequeño demo jugable de un plataformas-aventura 2D donde encarnas a un mago que debe derrotar a los enemigos que tiene delante (goblins, cuervos y ogros) hasta llegar a la meta final. El juego contaba con diferentes poderes ofensivos, mecanicas basicas de salot con coyote-time y IA basica para los enemigos, los cuales podían patrullar y atacar.",
        // Contacto
    ...
    en: {
        ...
        aeonbook_d:"The Aeon Book was a university project, which is a small playable demo of a 2D platform-adventure where you play a wizard who must defeat the enemies in front of him (goblins, crows and ogres) until reaching the final goal. The game had different offensive powers, basic salot mechanics with coyote-time and basic AI for enemies, which could patrol and attack.",
